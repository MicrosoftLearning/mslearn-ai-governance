...
param aiFoundryExternalNetworkAccess = readEnvironmentVariable('AI_FOUNDRY_EXTERNAL_NETWORK_ACCESS', 'Enabled')
param keyVaultExternalNetworkAccess = readEnvironmentVariable('KEY_VAULT_EXTERNAL_NETWORK_ACCESS', 'Enabled')
...
param deployDedicatedLanguageService = bool(readEnvironmentVariable('DEPLOY_DEDICATED_LANGUAGE_SERVICE', 'false'))
